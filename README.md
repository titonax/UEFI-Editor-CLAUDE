...
shows a screen/item tree laid out the same way the AMI Aptio HII menu is -
...
that table was located and cross-validated. A Pick Field's
...
`docs/phoenix/README.md`'s note on this). See
